...
| `EBAY_CLIENT_ID` / `EBAY_CLIENT_SECRET` (+ opt. `EBAY_CAMPAIGN_ID` for EPN) | auto-matches the catalog to live eBay prices (new + used legs of the spread), affiliate-tagged | optional |
