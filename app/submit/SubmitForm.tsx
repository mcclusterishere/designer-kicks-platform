    ...
    <form action={formAction} className="space-y-5">
      ...
      <div>
        <label htmlFor="morePhotos" className="tag text-smoke">
          More angles <span className="normal-case">(at least 2, up to 5 — voters swipe through these)</span>
        </label>
        <input
          id="morePhotos"
          name="morePhotos"
        ...
        />
        <p className="mt-1.5 text-xs text-smoke/70">
          Three photos minimum, cover included. Show the sides, the sole, and
          the detail somebody would ask about before they buy.
        </p>
      </div>
