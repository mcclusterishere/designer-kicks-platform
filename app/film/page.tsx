...
const SCENES: FilmScene[] = [
  ...
  {
    src: "/ad-videos/doomscroll.mp4",
    poster: "/ad-refs/doomscroll.jpg",
    eyebrow: "Chapter III · The Trap",
    headline: "Everybody scrolls. Almost nobody owns.",
    accent: "owns",
  ...
  {
    src: "/ad-videos/citywalk.mp4",
    poster: "/ad-refs/citywalk.jpg",
    eyebrow: "Chapter V · The Move",
    headline: "Move like the work is worth something.",
    accent: "worth something",
    sub: "Because now it is. The city blurs past; the ones who build walk in focus.",
  },
  {
    src: "/ad-videos/vault.mp4",
    poster: "/ad-refs/vault.jpg",
    eyebrow: "Chapter V · The Vault",
    headline: "The vault opens for the ones who build.",
    accent: "vault",
    sub: "Provenance, royalties, a portfolio with your name on it. Walk in.",
    ctas: [{ href: "/drafted", label: "Get Drafted" }],
  },
  {
